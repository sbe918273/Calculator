...
/**
 * An exception to throw iff the lexer encounters an invalid lexeme (a string that it cannot match to a token's lexeme).
 */
public class IllegalLexemeException extends PositionedException {
    /**
